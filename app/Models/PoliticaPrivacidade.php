...
class PoliticaPrivacidade extends Model
{
    ...
    /**
     * Get the responsavelPolitica for this model.
     *
     * @return App\Models\ResponsavelPolitica
     */
    public function responsavelPolitica()
    {
        return $this->hasOne('App\Models\ResponsavelPolitica', 'politica_privacidade_id', 'id');
    }

...
class Notificacao extends Model
{
	...
	public static function painelNotificarAfiliadoCategoriaAprovadaReprovada($categoria, $afiliado, $status="aprovado", $motivoRecusa=null){
		try {
			if($status=="aprovado"){
				Notificacao::create([
					"titulo" => "Categoria " . $categoria->nome . " APROVADA.",
					"corpo" => "Parabéns, você foi aprovado na categoria " . $categoria->nome ." e agora já pode receber solicitações desta categoria.",
					"link_interno_app" => null,
					"tipo_usuario" => "afiliado",
					"link_interno_app_label" => null,
					"param_name" => null,
			...
			} elseif($status=="reprovado" || $status=="recusado") {
				Notificacao::create([
					"titulo" => "Categoria " . $categoria->nome . " REPROVADA.",
					"corpo" => "Que pena, nossos administradores recusaram sua categoria." . ($motivoRecusa ? " MOTIVO: ".$motivoRecusa : null),
					"link_interno_app" => null,
					"tipo_usuario" => "afiliado",
					"link_interno_app_label" => null,
					"param_name" => null,
	...
	public static function painelNotificarAfiliadoDocumentoAprovadaReprovada($tipo, $afiliado, $status="aprovado", $motivoRecusa=null)
	{
		try {
			if($status=="aprovado"){
				Notificacao::create([
					"titulo" => "Documento $tipo APROVADO.",
					"corpo" => "Parabéns, seu documento $tipo foi aprovado.",
					"link_interno_app" => "afiliado/perfil/responsavel",
					"tipo_usuario" => "afiliado",
					"link_interno_app_label" => "Ver documentos",
					"param_name" => null,
					"usuario_app_id" => $afiliado->usuario_app_id,
					"param_link_interno" => null,
					"orcamento_id" => null
				...
				Notificacao::create([
					"titulo" => "Documento $tipo REPROVADO.",
					"corpo" => "Que pena, nossos administradores recusaram seu documento. Faça um novo envio." . ($motivoRecusa ? " MOTIVO: ".$motivoRecusa : null),
					"link_interno_app" => "afiliado/orcamentos/listar",
					"tipo_usuario" => "afiliado",
					"link_interno_app_label" => "Ver solicitações",
					"param_name" => null,
					"usuario_app_id" => $afiliado->usuario_app_id,
	...
	public static function painelNotificarAfiliadoNovoContratoRegiao($afiliado, $afiliado_regiao, $mensagem = null){
		try {
			return Notificacao::create([
				"titulo" => "Contrato disponível",
				"corpo" => "Parabéns, seu contrato de afiliado já está disponível.",
				"tipo_usuario" => "afiliado",
				"link_interno_app" => null,
				"link_interno_app_label" => null,
				"param_name" => null,
	...
	public static function painelNotificarUsuarioNovaNotificacao($usuario_app_id, $titulo, $mensagem)
	{
		try {
			Notificacao::create([
				"titulo" => $titulo,

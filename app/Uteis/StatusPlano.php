...
class StatusPlano
{
    ...
    {
        switch ($status) {
            case self::$ATIVO: return "#ffff00";
            case self::$INADIMPLENTE: return "#795548";
            case self::$EM_PROCESSO_CANCELAMENTO: return "#1976d2";
            case self::$CANCELADO: return "#990000";
            case self::$PENDENTE: return "#d32f2f";
            case self::$EM_PROCESSO_CANCELAMENTO: return "#d32f2f";
        }
    }
    ...
    {
        switch ($status) {
            case self::$ATIVO: return "success";
            case self::$INADIMPLENTE: return "danger";
            case self::$EM_PROCESSO_CANCELAMENTO: return "warning";
            case self::$CANCELADO: return "danger";
            case self::$PENDENTE: return "warning";
            case self::$EM_PROCESSO_CANCELAMENTO: return "warning";
        }
    }
}
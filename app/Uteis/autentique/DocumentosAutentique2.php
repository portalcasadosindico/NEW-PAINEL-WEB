...
class DocumentosAutentique2
{
    ...
    public static function enviarContratoServico($orcamento, $email_testemunha1, $email_testemunha2){
        // dd($orcamento);
        // Log::channel('orcamento')->info('Orcamento completo', $orcamento->condominio->sindico->usuarioApp->toArray());
        ...
        try{
            ...
            Log::channel('orcamento')->info('Verificando contrato e afiliado aqui');
            ...
            Log::channel('orcamento')->info('email sindico teste', ['email' => $emailSindico->email]);

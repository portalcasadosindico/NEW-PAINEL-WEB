  <div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="text" data-inputmask="'alias': 'numeric', 'radixPoint':',', 'groupSeparator': '.', 'digits': 2, 'digitsOptional': false, 'prefix': 'R$ ', 'placeholder': '0'"
          inputmode="decimal" class="form-control" id="valor" name="valor" value="{{ old('valor', optional($plano_disponivel_franqueado)->valor) }}" autocomplete="off" placeholder="Valor">
          @error('valor')
        ...
        <div class="form-group">
          ...
          <input type="text" data-inputmask="'alias': 'numeric', 'radixPoint':',', 'groupSeparator': '.', 'digits': 2, 'digitsOptional': false, 'prefix': 'R$ ', 'placeholder': '0'"
          inputmode="decimal" class="form-control" id="valor_comissao" name="valor_comissao" value="{{ old('valor_comissao', optional($plano_disponivel_franqueado)->valor_comissao) }}" autocomplete="off" placeholder="Valor comissao">

                ...
                <div class="pull-right">
                    ...
                    {{ csrf_field() }}
                        <div class="btn-group btn-group-sm" role="group">
                            <a href="{{ route('admin.orcamentos.index') }}" class="btn btn-primary" title="Ver todos orcamentos">
                                <i data-feather="list"></i>
                            </a>

                            <a href="{{ route('admin.orcamentos.create') }}" class="btn btn-success" title="Novo orcamento">

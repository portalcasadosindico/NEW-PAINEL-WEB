                ...
                <div class="pull-right">
                    ...
                    {{ csrf_field() }}
                        <div class="btn-group btn-group-sm" role="group">
                            <a href="{{ route('admin.planos_disponiveis_franqueado.index') }}" class="btn btn-primary" title="Ver todos plano_disponivel_franqueados">
                                <i data-feather="list"></i>
                            </a>

                            <a href="{{ route('admin.planos_disponiveis_franqueado.create') }}" class="btn btn-success" title="Novo plano_disponivel_franqueado">
                                <i data-feather="plus"></i>
                            </a>

                            <a href="{{ route('admin.planos_disponiveis_franqueado.edit', $plano_disponivel_franqueado->id ) }}" class="btn btn-primary" title="Editar plano_disponivel_franqueado">

                        ...
                        <div class="row">
                            <div class="col-md-12" style="padding: 8px;">
                                ...
                                <div style="margin-bottom: 16px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">
                                    ...
                                    <h5 class="badge badge-success" style="font-size: 16px; margin-top: 0px;">
                                        {{$afiliadoAsaas->asaas_customer_id}}
                                    </h5>
                            ...
                            <div class="col-md-6" style="padding: 8px;">
                                ...
                                <div style="overflow: hidden;">
                                    ...
                                    <a style="position: absolute; left: 63px; top: 69px;" href="{{Storage::url($contratoSocial->arquivo)}}" class="btn btn-primary" target="_blank">Ver
                                        arquivo</a>
                                    @else
                                    <a style="position: absolute; left: 63px; top: 69px;" href="{{ route('admin.afiliados.edit', $afiliado->id) }}" class="btn btn-danger">Upload</a>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="max-height: 300px; overflow: auto;">
                            @if(count($categorias_afiliado)>0)
                            <?php foreach ($categorias_afiliado as $cat_afil) {
                                ...
                                <label class="badge badge-secondary">{{$cat_afil->categoria ? $cat_afil->categoria->nome : "Categoria removida"}}
                                    ({{isset($super->nome) ? $super->nome : '--'}})</label><br>
                            <?php } ?>
                            @else
                            <h4>Nenhuma categoria aprovada ou pendente</h4>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body" style="max-height: 400px; overflow: auto;">
                        ...
                        ?>
                            <div style="border: 1px solid #dedede; padding: 12px; margin-bottom: 8px;">
                                <h4><a href="../orcamentos/{{$orcamento->id}}/edit" target="_blank">Ref.: #{{$orcamento->id}} -
                                        {{$orcamento->nome}}</a></h4>
                                @if($orcamento->deleted_at!=null)
                                <label class="badge badge-danger" style="font-size: 13px;">Deletado via painel</label>
                                @elseif($orcamento->status==6 || $orcamento->status==7 || $orcamento->status==8 || $orcamento->status==9)
                                ...
                                <label class="badge badge-secondary" style="font-size: 13px;" title="{{$orcamento->afiliado()->withTrashed()->first()->razao_social}} foi selecionado">Outro afiliado
                                    foi selecionado</label>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <dl class="dl-horizontal">
                            ...
                            <dd class="mail-link">
                                {{ isset($afiliado->usuarioApp->email) ? $afiliado->usuarioApp->email : 'Sem usuário app' }}
                            </dd>
                            <dt>Logo</dt>
                            <dd>
                                @if($afiliado->logo)
                                ...
                                @else
                                <a style="" href="{{ route('admin.afiliados.edit', $afiliado->id) }}" class="btn btn-danger">Upload</a>
                                @endif
                            </dd>
                        </dl>
                    </div>
                        ...
                        <div class="modal fade" id="regiao_afiliado_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    <form id="form_regiao" method="POST" class="forms-sample" action="{{ route('admin.afiliados.store_regiao') }}" enctype="multipart/form-data">
                                        <input type="hidden" name="afiliado_id" value="{{$afiliado->id}}">
                                        <input type="hidden" name="franqueado_id" id="franqueado_id" value="">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Adicionando região ao afiliado</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="regiao_id" id="regiao_id" onchange="verificarTokens(this.value)">
                                                            ...
                                                            @else
                                                            @foreach($regioesDisponiveis as $regiao)
                                                            <option value="{{$regiao->id}}">{{$regiao->nome}} - {{$regiao->franqueado->nome}}</option>
                                                            @endforeach
                                                            @endif
                                                        </select>
                                                        @foreach($regioesDisponiveis as $regiao)
                                                        <input type="hidden" id="franqueado-regiao-{{$regiao->id}}" value='<?php echo json_encode($regiao->franqueado); ?>'>
                                                        @endforeach
                                                    </div>
                                                    @else
                                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="assinatura_asaas" id="assinatura_asaas">
                                                    {{-- @if($possuiTokenAsaas)
                                                            <option value="1" id="assinatura_asaas_option">Criar assinatura no ASAAS</option>
                                                        @else 
                                                            <option value="1" id="assinatura_asaas_option" disabled>Criar assinatura no ASAAS (Não possui Token do Asaas)</option>
                                                        @endif --}}
                                                    <option value="1" id="assinatura_asaas_option">Criar assinatura no ASAAS</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select onchange="showHideTestemunhas(this.value)" name="tipo_assinatura" id="tipo_assinatura">
                                                    ...
                                                    <option value="1" id="assinatura_autentique">Colher assinaturas pelo Autentique</option>
                                                    @else
                                                    <option value="1" disabled id="assinatura_autentique">Colher assinaturas pelo Autentique (Não
                                                        possui Token do Autentique)</option>
                                                    @endif
                                            ...
                                            <div class="row container-testemunhas" style="display: none;">
                                                <div class="col col-md-6">
                                                    <div class="form-group">
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            {{$item->id}}
                                            <br>
                                            @if( (isset($planoAssinatura->statusPlano) && $planoAssinatura->statusPlano==2) ||
                                            isset($planoAssinatura->data_cancelamento) && $planoAssinatura->data_cancelamento!=null))
                                            <a href="javascript:void(0)" class="text-danger" onclick="removerAfiliadoRegiao({{$item->id}})">Remover filiação</a>
                                            @else
                                            <a href="javascript:void(0)" class="text-warning" onclick="alert('Você precisa cancelar a assinatura no ASAAS por favor.')">Remover filiação</a>
                                            @endif
                                        </td>
                                        <td>
                                            @if($item->modo=='debug')
                                            ...
                                            <a href="{{$planoAssinatura->arquivo_original_autentique}}" target="_blank">Contrato original
                                                autentique</a>
                                            <br><br>
                                            <a href="{{$planoAssinatura->arquivo_assinado}}" target="_blank">Contrato assinado autentique</a>
                                            ...
                                            @endif
                                            <br><br>
                                            <a href="javascript:void(0)" onclick="showHideAssinaturasPlano(<?php echo $planoAssinatura->id; ?>)">Ver assinaturas</a>
                                                ...
                                                <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #009900; ">
                                                    ...
                                                    <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #999900; ">
                                                        ...
                                                        <label>Nome assinante:
                                                            <?php echo !empty($assinaturas[$planoAssinatura->id]["afiliado"]->nome_assinante) ? $assinaturas[$planoAssinatura->id]["afiliado"]->nome_assinante : "--"; ?></label><br>
                                                        <label>E-mail:
                                                            <?php echo !empty($assinaturas[$planoAssinatura->id]["afiliado"]->email) ? $assinaturas[$planoAssinatura->id]["afiliado"]->email : "--"; ?></label><br>
                                                        <label>Data visualização:
                                                            <?php echo !empty($assinaturas[$planoAssinatura->id]["afiliado"]->viewed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["afiliado"]->viewed) : "--"; ?></label><br>
                                                        <label>Data assinatura:
                                                            <?php echo !empty($assinaturas[$planoAssinatura->id]["afiliado"]->signed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["afiliado"]->signed) : "--"; ?></label><br>
                                                        @if(!empty($assinaturas[$planoAssinatura->id]["afiliado"]->rejected))
                                                        <label>Data rejeitado:
                                                            <?php echo !empty($assinaturas[$planoAssinatura->id]["afiliado"]->rejected) ? Formatacao::data($assinaturas[$planoAssinatura->id]["afiliado"]->rejected) : "--"; ?></label>
                                                        @endif
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #009900; ">
                                                        ...
                                                        <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #999900; ">
                                                            ...
                                                            <h6>Franqueado</h6>
                                                            <label>E-mail:
                                                                <?php echo !empty($assinaturas[$planoAssinatura->id]["franqueado"]->email) ? $assinaturas[$planoAssinatura->id]["franqueado"]->email : "--"; ?></label><br>
                                                            <label>Data visualização:
                                                                <?php echo !empty($assinaturas[$planoAssinatura->id]["franqueado"]->viewed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["franqueado"]->viewed) : "--"; ?></label><br>
                                                            <label>Data assinatura:
                                                                <?php echo !empty($assinaturas[$planoAssinatura->id]["franqueado"]->signed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["franqueado"]->signed) : "--"; ?></label><br>
                                                            @if(!empty($assinaturas[$planoAssinatura->id]["franqueado"]->rejected))
                                                            <label>Data rejeitado:
                                                                <?php echo !empty($assinaturas[$planoAssinatura->id]["franqueado"]->rejected) ? Formatacao::data($assinaturas[$planoAssinatura->id]["franqueado"]->rejected) : "--"; ?></label>
                                                            @endif
                                                        </div>
                                                        <hr>
                                                        ...
                                                        <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #009900; ">
                                                            ...
                                                            <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #999900; ">
                                                                ...
                                                                <h6>Testemunha 1</h6>
                                                                <label>E-mail:
                                                                    <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha1"]->email) ? $assinaturas[$planoAssinatura->id]["testemunha1"]->email : "--"; ?></label><br>
                                                                <label>Data visualização:
                                                                    <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha1"]->viewed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["testemunha1"]->viewed) : "--"; ?></label><br>
                                                                <label>Data assinatura:
                                                                    <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha1"]->signed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["testemunha1"]->signed) : "--"; ?></label><br>
                                                                @if(!empty($assinaturas[$planoAssinatura->id]["testemunha1"]->rejected))
                                                                <label>Data rejeitado:
                                                                    <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha1"]->rejected) ? Formatacao::data($assinaturas[$planoAssinatura->id]["testemunha1"]->rejected) : "--"; ?></label>
                                                                @endif
                                                            </div>
                                                            <hr>
                                                            ...
                                                            <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #009900; ">
                                                                ...
                                                                <div style="background:#fff; padding: 8px; border-radius: 8px; border: 1px solid #ccc; border-left: 3px solid #999900; ">
                                                                    ...
                                                                    <h6>Testemunha 2</h6>
                                                                    <label>E-mail:
                                                                        <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha2"]->email) ? $assinaturas[$planoAssinatura->id]["testemunha2"]->email : "--"; ?></label><br>
                                                                    <label>Data visualização:
                                                                        <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha2"]->viewed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["testemunha2"]->viewed) : "--"; ?></label><br>
                                                                    <label>Data assinatura:
                                                                        <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha2"]->signed) ? Formatacao::data($assinaturas[$planoAssinatura->id]["testemunha2"]->signed) : "--"; ?></label><br>
                                                                    @if(!empty($assinaturas[$planoAssinatura->id]["testemunha2"]->rejected))
                                                                    <label>Data rejeitado:
                                                                        <?php echo !empty($assinaturas[$planoAssinatura->id]["testemunha2"]->rejected) ? Formatacao::data($assinaturas[$planoAssinatura->id]["testemunha2"]->rejected) : "--"; ?></label>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            @else
                                                            ...
                                                            <a href="{{Storage::url($item->afiliado->contrato_gerado)}}" target="_blank">Ver contrato
                                                                assinado (Autenticado franqueado)</a>
                                                            <br>
                                                            @if($item->afiliado->data_contrato)
                                                            Data contrato: <?php echo Formatacao::data($item->afiliado->data_contrato); ?><br>
                                                            @endif
                                                            @if($item->afiliado->data_ativacao)
                                                            Data Ativação: <?php echo Formatacao::data($item->afiliado->data_ativacao); ?><br>
                                                            @endif
                                                            @else
                                                            <a href="javascript:void(0)" class="btn btn-danger" data-toggle="modal" data-target="#regiao_afiliado_upload_contrato_modal_{{$planoAssinatura->id}}">Upload do
                                                                contrato</a>
                                                            <br>
                                                            ...
                                                            <div class="modal fade" id="regiao_afiliado_gerar_contrato_modal_{{$planoAssinatura->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-md" role="document">
                                                                    <div class="modal-content">
                                                                        <form id="form_regiao_{{$planoAssinatura->id}}" method="POST" class="forms-sample" action="{{ route('admin.afiliados.store_contrato') }}" enctype="multipart/form-data">
                                                                            <input type="hidden" name="afiliado_id" value="{{$afiliado->id}}">
                                                                            <input type="hidden" name="plano_assinatura_afiliado_regiao_id" value="{{$planoAssinatura->id}}">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Gerando contrato automaticamente
                                                                                </h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    @if($possuiTokenAutentique)
                                                                                    <h5>O sistema irá colher as assinaturas pelo Autentique.</h5>
                                                                                    <p>
                                                                                        Sua assinatura de franqueado já será realizada automaticamente neste documento
                                                                                        ;)
                                                                                    </p>
                                                                                    @else
                                                                                    <label>Você precisa inserir o token do Autentique. Vá até o seu <a href="../perfil/edit">Perfil</a> e siga as instruções.</label>
                                                                                    @endif
                                                                                </div>

                                                                                @if($possuiTokenAutentique)
                                                                                <h5>Informe a data de início do contrato</h5>
                                                                                ...
                                                                                <h5>Precisamos do e-mail de duas testemunhas</h5>
                                                                                <div class="row container-testemunhas contrainer-{{$planoAssinatura->id}}">
                                                                                    <div class="col col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label for="email_testemunha1">E-mail testemunha 1</label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    @if($planoAssinatura->isTerceirizada==1)
                                                                                    <h5>O sistema escolheu o template para contrato <u>Terceirizada</u> <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Como chegamos nesta conclusão?" data-content="O plano que o afiliado optou foi marcado pelo super admin como um plano de Terceirizadas. Quando um plano é marcado como Terceirizada, não importa o percentual de comissão, o contrato será considerado como o de Terceirizada."><i class="fa fa-question"></i></button></h5>
                                                                                    @elseif($planoAssinatura->valor_comissao!==null &&
                                                                                    $planoAssinatura->valor_comissao==0)
                                                                                    <h6>O sistema escolheu o template para contrato <u>Não Comissionado</u> <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Como chegamos nesta conclusão?" data-content="O plano que o afiliado optou não possui comissão."><i class="fa fa-question"></i></button></h6>
                                                                                    @elseif($planoAssinatura->valor_comissao>0)
                                                                                    <h5>O sistema escolheu o template para contrato <u>Comissionado</u> <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Como chegamos nesta conclusão?" data-content="O plano que o afiliado optou possui uma comissão de {{$planoAssinatura->valor_comissao}}%."><i class="fa fa-question"></i></button></h5>
                                                                                    @else
                                                                                    <h5>O sistema escolheu o template para contrato <u>Normal</u> <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Como chegamos nesta conclusão?" data-content="O plano que o afiliado optou não possui comissionamento."><i class="fa fa-question"></i></button></h5>
                                                                                    @endif
                                                                                </div>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                @if($possuiTokenAutentique)
                                                                                <button type="button" id="btn-gerar-{{$item->id}}" class="btn btn-primary" onclick="gerarContrato('{{$item->id}}')">Gerar Contrato</button>
                                                                                @else
                                                            ...
                                                            <div class="modal fade" id="regiao_afiliado_upload_contrato_modal_{{$planoAssinatura->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-md" role="document">
                                                                    <div class="modal-content">
                                                                        <form id="form_regiao_upload_{{$planoAssinatura->id}}" method="POST" class="forms-sample" action="{{ route('admin.afiliados.store_contrato') }}" enctype="multipart/form-data">
                                                                            <input type="hidden" name="afiliado_id" value="{{$afiliado->id}}">
                                                                            <input type="hidden" name="plano_assinatura_afiliado_regiao_id" value="{{$planoAssinatura->id}}">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Upload do contrato</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select onchange="showHideTestemunhasUpload(this.value, <?php echo $planoAssinatura->id; ?>)" name="tipo_assinatura" id="tipo_assinatura">
                                                                                        ...
                                                                                        @else
                                                                                        <option value="1" disabled>Colher assinaturas pelo Autentique (Não possui
                                                                                            Token do Autentique)</option>
                                                                                        @endif
                                                                                        <option value="2">Contrato já está assinado por todos</option>
                                                                                    </select>
                                                                                </div>

                                                                                <div class="row container-testemunhas contrainer-{{$planoAssinatura->id}}" style="display: none;">
                                                                                    <div class="col col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label for="email_testemunha1">E-mail testemunha 1</label>
                                                                                            <input type="text" class="form-control" placeholder="E-mail testemunha 1" name="email_testemunha1" id="email_testemunha1">
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            @endif
                                            <label class="badge badge-primary" style="font-size: 14px;">{{isset($planoAssinatura->nome) ? $planoAssinatura->nome : 'Sem plano assinado'}}</label>
                                            <a href="javascript:void(0)" onclick="detalhesPlano({{$item->id}})">+ Detalhes</a>
                                            <div class="mais-info mais-info-{{$item->id}}">
                                                <label class="badge badge-info">Data de assinatura:
                                                    <?php echo isset($planoAssinatura->data_cadastro) ? Formatacao::data($planoAssinatura->data_cadastro) : 'Sem data de cadastro'; ?></label>
                                                <br><label class="badge badge-info">Valor:
                                                    {{isset($planoAssinatura->valor) ? $planoAssinatura->valor : 0}}</label>
                                                <label class="badge badge-info">Comissão:
                                                    {{isset($planoAssinatura->valor_comissao) ? $planoAssinatura->valor_comissao : 0}}</label>
                                                <br>
                                                ...
                                                <label class="badge badge-success">Expira em:
                                                    <?php echo Formatacao::data($planoAssinatura->data_expiracao); ?></label>
                                                ...
                                                @if(isset($planoAssinatura->data_cancelamento) && $planoAssinatura->data_cancelamento)
                                                <label class="badge badge-danger">Cancelado em em:
                                                    <?php echo Formatacao::data($planoAssinatura->data_cancelamento); ?></label>
                                                @endif
                                            </div>
                                            <br><br>


                                            @if(isset($planoAssinatura->statusPlano) && $planoAssinatura->data_cancelamento==null)
                                            <label class="badge badge-<?php echo StatusPlano::getColorTheme($planoAssinatura->statusPlano); ?>" style="font-size: 12px;">Status:
                                                <?php echo StatusPlano::getLabel($planoAssinatura->statusPlano); ?></label>
                                            @endif

                                            @if(isset($planoAssinatura->asaas_assinatura_id) && $planoAssinatura->asaas_assinatura_id)
                                            ...
                                            <br><br>
                                            @if($possuiTokenAsaas)
                                            <a href="javascript:alert('Você deve logar como franqueado')">Vincular ao ASAAS</a>

                                            <div class="container-vincular-asaas" style="display: none;">
                                                ...
                                                <label>Achamos que uma destas assinaturas do ASAAS pode integrar com o sistema <b>Casa do
                                                        Síndico</b> para a região deste afiliado</label>
                                                @foreach($assinaturasCustomer as $assinaturaCust)
                                                @if(!$assinaturaCust['externalReference'] && $planoAssinatura->valor==$assinaturaCust['value'])
                                                <?php $cont++; ?>
                                                <div class="row" style="border: 1px solid #ccc; padding: 6px;">
                                                    ...
                                                    <div class="col-md-6" style="text-align: center;">
                                                        <a style="position: relative; top: 40%;" href="javascript:void(0)" onclick="vincularAssinatura('<?php echo $assinaturaCust['id']; ?>', '<?php echo $planoAssinatura->id; ?>')">Clique
                                                ...
                                                @endforeach
                                                @if($cont==0)
                                                <label class="badge badge-warning">Nenhuma assinatura encontrada. Crie uma com o botão <b>Vincular
                                                        ao asaas criando nova assinatura</b>.</label>
                                                @endif
                                                @endif
                                            </div>
                                            @else
    ...
    <div class="pull-right">
        <form method="POST" action="{!!  route('admin.afiliados.destroy', $afiliado->id) !!}" accept-charset="UTF-8">
            ...
            <div class="btn-group btn-group-sm" role="group">
                <a href="{{ route('admin.afiliados.index') }}" class="btn btn-primary" title="Ver todos afiliados">
                    <i data-feather="list"></i>
                </a>

                <a href="{{ route('admin.afiliados.create') }}" class="btn btn-success" title="Novo afiliado">
...
<script>
    ...
    function validarForm() {
        ...
        if ($("#tipo_assinatura").val() == 1) {
            ...
            if ($("#email_testemunha2").val() == $("#email_testemunha1").val()) {
                alert("As testemunhas não podem ser a mesma pessoa.");
                $("#email_testemunha2").focus();
                return;
            }
        }
    ...
    function vincularAsaasShow() {
        if ($(".container-vincular-asaas").css("display") == "none") {
            $(".container-vincular-asaas").show(300);
        } else {
            $(".container-vincular-asaas").hide(300);
        }
    }
    ...
    function inserirAssinatura() {
        if (confirm("Deseja criar uma assinatura para este afiliado?")) {
            window.location = "../afiliados/{{$afiliado->id}}/inserirassinatura/";
        }
    }
    ...
    function vincularAssinatura(plano_assinatura_asaas_id, plano_assinatura_afiliado_id) {
        if (confirm("Deseja vincular esta assinatura no ASAAS?")) {
            window.location = "../afiliados/{{$afiliado->id}}/vincularassinaturaexistente/" + plano_assinatura_asaas_id + "/" +
                plano_assinatura_afiliado_id;
        }
    }
    ...
    function verificarTokens(regiao_id) {
        var franqueado = JSON.parse($("#franqueado-regiao-" + regiao_id).val())
        $("#franqueado_id").val(franqueado.id)
        if (franqueado.possuiTokenAsaas == true) {
            $("#assinatura_asaas_option").html("Criar assinatura no ASAAS")
            $("#assinatura_asaas_option").removeAttr("disabled")
        } else {
            $("#assinatura_asaas_option").html("Criar assinatura no ASAAS (Não possui Token do Asaas)")
            $("#assinatura_asaas_option").attr("disabled", "disabled")
        }

        if (franqueado.possuiTokenAutentique == true) {
            $("#assinatura_autentique").html("Colher assinaturas pelo Autentique")
            $("#assinatura_autentique").removeAttr("disabled")
        } else {
            $("#assinatura_autentique").html("Colher assinaturas pelo Autentique (Não possui Token do Autentique)")
            $("#assinatura_autentique").attr("disabled", "disabled")
        }
    }
    ...
    function removerAfiliadoRegiao(afiliado_regiao_id) {
        if (confirm(
                "Esta ação irá fazer com que os usuários não vejam mais esta filiação. Isso não irá remover a assinatura no ASAAS e nem no Autentique. Confirma remover esta filiação?"
            )) {
            window.location = "../afiliados_regiao/remover/" + afiliado_regiao_id;
        }
    }
</script>
@endpush
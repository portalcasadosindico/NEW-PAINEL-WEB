...
<p style="text-align:justify">
    ...
    <br>
    1º - O valor contratual será de <?=formatarValor($planoAssinatura->valor)?> (<?=$planoAssinatura->valor_extenso?>)  mensais, mais <?=formatarPercentual($planoAssinatura->valor_comissao)?> de comissão referente Ao valor total da mão de obra aplicada em cada serviço.
    <br>

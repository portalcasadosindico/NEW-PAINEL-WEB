...
<p style="text-align:justify">
    ...
    <br>
    1º - O valor contratual será de <?=formatarValor($afiliado->valorPlano)?> (<?=$afiliado->valorPlanoExtenso?>) mensais, mais <?=formatarPercentual($afiliado->valorComissao)?> de comissão referente Ao valor total da mão de obra aplicada em cada serviço.
    <br>

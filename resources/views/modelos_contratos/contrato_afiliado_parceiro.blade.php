<div style="width:100%; text-align: center;">
    ...
    <br>
    <h2 style="text-align: center; margin-bottom: 3px;">CONTRATO DE PARCERIA.</h2>
    <h4 style="margin:0px;">Empresa parceira Casa do Síndico.</h4>
</div>
...
em site específico da <b style='mso-bidi-font-weight:normal'>CONTRATRADA</b>, assim
como em todas as mídias sociais e também malas diretas para as nossas empresas
filiadas e condomínios seja comercial, residencial e/ou shoppings.</span></p>
...
- Divulgar cursos, palestras e reuniões periódicas para melhorar o
funcionamento do grupo, aplicar ajustes de mudança de mercado, apresentação da
evolução e andamento dos negócios aplicados.</span></p>
...
normal'> </b><span style='mso-bidi-font-weight:bold'>de <span
style='mso-spacerun:yes'> </span><span style='mso-spacerun:yes'> </span>prazo</span><b
...
<p class=MsoNormal style='line-height:150%'><span style='font-family:"Verdana",sans-serif'>1º
- O contrato entre as partes não tem valores de mensalidades, matrícula, adesão
ou qualquer outro em benefício da <b>CONTRATADA</b>.</span></p>

<p class=MsoNormal style='line-height:150%'><span style='font-family:"Verdana",sans-serif'>2º
- A <b>CONTRATANTE</b>, se compromete por força de contrato a aplicar descontos
e/ou outras vantagens ao cliente final indicado pela <b>CONTRATADA</b>, identificado
através do cartão personalizado (CONDS), as referidas vantagens e descontos
terão que ser alheia as promoções e descontos já aplicado ao publico comum.</span></p>
...
os clientes final da <b style='mso-bidi-font-weight:normal'>CONTRATADA</b>
obriga-se a:</span></p>
...
style='font-family:"Verdana",sans-serif;mso-bidi-font-family:Arial'>9º - Manter
...
<p class=MsoNormal align=left style='text-align:left;line-height:150%'><span
style='font-family:"Verdana",sans-serif;mso-bidi-font-family:Arial'>10º - </span><span
...
<p class=MsoNormal style='line-height:150%'><span style='font-family:"Verdana",sans-serif'>4º
A <b>CONTRATANTE</b>, obriga-se a dar garantia das obras, serviços e/ou
materiais por ela fornecida ou executada, nos moldes antes descritos nos
contratos cuja consta a anuência da <b>CONTRATADA</b>, mesmo que já tenha se
desfiliado da CASA DO SINDICO, sob pena de ação judicial para reparo de danos a
<b>CONTRATADA </b>ou mesmo ao cliente final, ou seja, o condomínio.</span></p>

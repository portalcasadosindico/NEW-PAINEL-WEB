...
<p style="text-align:justify">
    ...
    <br>
    1º - O valor contratual será de <?=formatarValor($afiliado->valorPlano)?> (<?=$afiliado->valorPlanoExtenso?>) mensais, sem qualquer comissão referente a serviços prestados.
    <br>

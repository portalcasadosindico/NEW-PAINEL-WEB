    ...
    <div class="col-sm-6">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" name="email" value="{{ old('email', optional($franqueado)->email) }}" autocomplete="off" placeholder="Email">
            @error('email')
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="cnpj" data-inputmask-alias="99.999.999/9999-99" name="cnpj" value="{{ old('cnpj', optional($franqueado)->cnpj) }}" autocomplete="off" placeholder="Cnpj">
            @error('cnpj')
        ...
        <div class="card" id="tokens">
          <div class="card-body">
              ...
              <div class="form-group">
                <label for="token_asaas_producao">Token ASAAS Produção</label>
                
                @if($franqueado->token_asaas_producao!="")
                  <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Como alterar este dado?" data-content="Se desejar alterar o token do asaas, você deve entrar em contato com a Matriz."><i class="fa fa-question"></i></button>
                  <input  type="text" disabled class="form-control disabled" value="SEU TOKEN JÁ FOI INSERIDO">
                @else
                  <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Saiba para que serve" data-content="Esse é o código para que os afiliados possam inscever-se em suas regiões, integrando diretamete no seu ASAAS."><i class="fa fa-question"></i></button>
                  <input  type="text" class="form-control disabled" id="token_asaas_producao" name="token_asaas_producao" value="{{ old('token_asaas_producao', optional($franqueado)->token_asaas_producao) }}" autocomplete="off" placeholder="Token asaas">
              ...
              <div class="form-group">
                ...
                @if($franqueado->token_asaas_debug!="")
                  <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Como alterar este dado?" data-content="Se desejar alterar o token do asaas, você deve entrar em contato com a Matriz."><i class="fa fa-question"></i></button>
                  <input  type="text" disabled class="form-control disabled" value="SEU TOKEN JÁ FOI INSERIDO">
                @else
              ...
              <div class="form-group">
                ...
                @if($franqueado->token_autentique!="")
                  <button type="button" class="btn-question" data-trigger="focus" data-toggle="popover" title="Como alterar este dado?" data-content="Se desejar alterar o token do Autentique, você deve entrar em contato com a Matriz."><i class="fa fa-question"></i></button>
                  <input  type="text" disabled class="form-control disabled" value="SEU TOKEN JÁ FOI INSERIDO">
                @else
                  <button type="button"  class="btn-question" data-trigger="focus" data-toggle="popover" title="Saiba para que serve" data-content="Esse é o código para que o sistema possa coletar as assinaturas entre afiliado e franqueado e assinaturas dos contratos de serviços, utilizando o seu perfil da plataforma Autentique."><i class="fa fa-question"></i></button>
    ...
    <div class="card">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="telefone_responsavel" data-inputmask-alias="(99) 99999-9999"  name="telefone_responsavel" value="{{ old('telefone_responsavel', optional($franqueado)->telefone_responsavel) }}" autocomplete="off" placeholder="Telefone responsavel">

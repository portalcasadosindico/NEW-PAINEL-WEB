    ...
    @if(Session::has('success_message'))
     ...
     @endif
            <div class="panel-heading clearfix">
               ...
               <div class="pull-left">
                    <a href="{{ route('admin_franqueado.sindicos.create') }}" class="btn btn-success" title="Criar novo sindico">
               ...
               <table data-page-length="25" id="dataTableExample" class="table table-striped dataTable no-footer" role="grid" aria-describedby="dataTableExample_info">
                       ...
                       @foreach($sindicos as $sindico)
                               <td>
                                    ...
                                    <span class="citacao">
                                        -
                                        Via <b>{{$sindico->forma_cadastro}}</b>
                               ...
                               <td>
                                    ...
                                    @endif
                                    @if(isset($sindico->usuarioApp) && $sindico->usuarioApp->isFacebook == 1)
                                        <label class="badge badge-primary">Login pelo Facebook</label>
                                    @endif

                                    @if(isset($sindico->usuarioApp) && $sindico->usuarioApp->isEmail == 1)
                               ...
                               <td>
                                   @if($sindico->data_inicio_mandato && $sindico->data_fim_mandato)
                                        De <?php echo Formatacao::data($sindico->data_inicio_mandato, false, false); ?> até <?php echo Formatacao::data($sindico->data_fim_mandato); ?>
                                   @else
                                        --
                                   @endif
                               </td>
                               <td align="right">
                                   ...
                                   {{ csrf_field() }}
                                       ...
                                       <div class="btn-group btn-group-xs pull-right" role="group">
                                           <a href="{{ route('admin_franqueado.sindicos.show', $sindico->id ) }}" class="btn btn-info" title="Ver sindico">
                                               <i class="fa fa-eye"></i>
                                           </a>

                ...
                <div class="pull-right">
                    ...
                    {{ csrf_field() }}
                        <div class="btn-group btn-group-sm" role="group">
                            <a href="{{ route('admin_franqueado.vistorias.index') }}" class="btn btn-primary" title="Ver todos vistorias">
                                <i data-feather="list"></i>
                            </a>

                            <a href="{{ route('admin_franqueado.vistorias.create') }}" class="btn btn-success" title="Novo vistoria">
  ...
  <script>
      function removerFoto(imagem_vistoria_id){
          if(confirm("Deseja realmente remover esta foto?")){
            ...
            $.getJSON({
                url: "<?php echo getenv("APP_URL"); ?>/admin_franqueado/vistoria_imagens/"+imagem_vistoria_id,
                method: "DELETE",
                data: {
                    _token: _token
                },

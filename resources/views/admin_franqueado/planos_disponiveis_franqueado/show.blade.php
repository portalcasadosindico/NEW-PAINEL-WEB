       	...
       	<div class="card">
        	<div class="card-body">
                ...
                <div class="pull-right">
                    <form method="POST" action="{!! route('admin_franqueado.planos_disponiveis_franqueado.destroy', $plano_disponivel_franqueado->id) !!}" accept-charset="UTF-8">
                    <input name="_method" value="DELETE" type="hidden">
                    {{ csrf_field() }}
                        <div class="btn-group btn-group-sm" role="group">
                            <a href="{{ route('admin_franqueado.planos_disponiveis_franqueado.index') }}" class="btn btn-primary" title="Ver todos plano_disponivel_franqueados">
                                <i data-feather="list"></i>
                            </a>

                            <a href="{{ route('admin_franqueado.planos_disponiveis_franqueado.create') }}" class="btn btn-success" title="Novo plano_disponivel_franqueado">
                                <i data-feather="plus"></i>
                            </a>

                            <a href="{{ route('admin_franqueado.planos_disponiveis_franqueado.edit', $plano_disponivel_franqueado->id ) }}" class="btn btn-primary" title="Editar plano_disponivel_franqueado">

    ...
    <script>
     ...
     // $(document).ready( function () {
      ...
      whatsLinkDo();
          ...
          $("#pesquisa_table_input").keyup(function(event){
            var termos = $(this).val();
            var tecla = event.which || event.keyCode;
            if(tecla==13) {
              dataTable.search($("#pesquisa_table_input").val()).draw();
              dataTableDesc.search($("#pesquisa_table_input").val()).draw();
              dataTableNoOrder.search($("#pesquisa_table_input").val()).draw();
              return false;
            }
            return true;
          });

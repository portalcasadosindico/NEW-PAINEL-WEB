     ...
     @endif  
            ...
            <div class="panel-heading clearfix">
               ...
               <div class="btn-group btn-group-sm pull-right" role="group">
                   <a href="{{ route('admin.vistorias.create') }}" class="btn btn-success" title="Criar nova vistoria">
                               ...
                               <td align="right">
                                   ...
                                   {{ csrf_field() }}
                                       ...
                                       <div class="btn-group btn-group-xs pull-right" role="group">
                                           <a href="{{ route('admin.vistorias.show', $vistoria->id ) }}" class="btn btn-info" title="Ver vistoria">
                                               <i class="fa fa-eye"></i>
                                           </a>

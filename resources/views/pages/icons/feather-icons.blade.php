      ...
      <div class="card-body">
        ...
        <div class="container">
          <div class="icons-list row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-pencil"></i> edit </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-eye"></i> eye </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3"> <i class="fa fa-trash"></i> trash </div>
